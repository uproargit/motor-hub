...
if (r2Set.length === 0) {
  problems.push(
    "No R2 bucket is configured. Uploaded receipts and photos would be written to\n" +
      "    local disk and lost. Set: " + r2.join(", "),
  );
...
console.log("Environment looks good: passphrase set, Turso configured, R2 configured.");
